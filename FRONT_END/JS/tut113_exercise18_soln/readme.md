You have to use an apu and dusplay the data in the form of a card under a container. All the data points returned by the api should be converted to card..
